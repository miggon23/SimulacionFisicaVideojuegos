...
//----------------------------
class RainGenerator : public GaussianParticleGenerator {
protected:
    float std_dev_rad; //Radio de la partícula
    float mean_rad;
public:
    RainGenerator(Vector3 dvPos, Vector3 dvVel, double dvT, Vector3 posM, Vector3 velM, int nPart, float radiusM, float dvRad);
